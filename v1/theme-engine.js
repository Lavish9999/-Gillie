...
(() => {
  ...
  const FALLBACK_THEMES = Object.freeze({
    ...
    sunset: {
      id: "sunset",
      name: "Sunset Lagoon",
      tint: "linear-gradient(180deg, rgba(255,158,92,.56), rgba(242,112,138,.42))",
      blend: "soft-light",
      sand: "#F2D2A8",
      premium: true,
    },
    abyss: {
      id: "abyss",
      name: "Abyss",
      tint: "linear-gradient(180deg, rgba(24,46,92,.48), rgba(10,22,54,.64))",
      blend: "multiply",
      sand: "#9AA4B8",
      premium: true,
    },
    sakura: {
      id: "sakura",
      name: "Sakura",
      tint: "linear-gradient(180deg, rgba(255,190,214,.62), rgba(255,150,190,.42))",
      blend: "soft-light",
      sand: "#F6DCCB",
      premium: true,
    },
    moonlit: {
      id: "moonlit",
      name: "Moonlit Reef",
      tint: "linear-gradient(180deg, rgba(79,91,154,.42), rgba(16,25,67,.72))",
      blend: "multiply",
      sand: "#9296AC",
      premium: true,
    },
  ...
  function openPlus() {
    ...
    const trigger = $("#plus-open") || $("#set-plus") || $("[data-act='plus']");
    trigger?.click();
  }
  ...
  function selectTheme(themeId, { announce = true, reason = "tap" } = {}) {
    const current = currentState();
  ...
  function handleThemeClick(event) {
    ...
    event.preventDefault();
    event.stopImmediatePropagation();
    selectTheme(theme.id, { announce: true, reason: "theme-card-tap" });
  }
